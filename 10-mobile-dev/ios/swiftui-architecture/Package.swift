...
let package = Package(
    ...
    targets: [
        ...
        .target(
            name: "swiftui-architecture",
            dependencies: [],
            path: "Sources/swiftui-architecture"
        ),

        // Example executables
        .executableTarget(
            name: "Example1",
            dependencies: ["swiftui-architecture"],
        ...
        // Test target
        .testTarget(
            name: "swiftui-architectureTests",
            dependencies: ["swiftui-architecture"],
            path: "Tests/swiftui-architectureTests"
        )
    ]
)
